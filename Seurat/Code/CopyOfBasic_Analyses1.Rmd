...
```{r}
obj <- readRDS("../Data/wu_liu_scVI3.rds")
#obj <- liu_wu_scVI_clustered1
```
...
obj <- RunPCA(object = obj,
               features = obj@assays$wu_liu_scVI_imputation@var.features,
               npcs = 100,
               verbose = TRUE,
               set.seed = 42,
               ndims.print = 1:5,
...
```
```{r}
tiff("scVI_Round3_FeaturePlot.tiff", width = 16, height = 8, units = 'in', res = 300)
FeaturePlot(obj, features = c("TNNI3", "PECAM1","TBX5", "TNNT1","PTCH1", "PTCH2","HAND1", "HAND2","OSR1","ISL1","GATA4","MEF2C"), dims = c(2, 1), ncol = 4, max.cutoff = c('q90','q90','q90','q90','q90','q90','q90','q90','q90','q90','q90','q90'))
